...
const Widget = (props: AllWidgetProps<{}>) => {
  ...
  React.useEffect(() => {
    console.log('Widget props:', props); // Log all props for debugging
    console.log('All widget IDs:', props.allWidgetIds); // Log all widget IDs in the app
    console.log('Map widget IDs:', props.useMapWidgetIds); // Log specific map widget IDs
  ...
  return (
    <div className="widget-dasymetric jimu-widget" style={{ padding: '10px' }}>
      ...
      <JimuMapViewComponent
        useMapWidgetId={props.useMapWidgetIds?.[0] || 'WIDGET_1'} // Try default for testing
